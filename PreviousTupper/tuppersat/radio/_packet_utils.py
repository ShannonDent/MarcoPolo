...
def DataPacket(callsign, index, hhmmss=None,
                    UVA=None, UVB=None, UVC=None, Ozone=None,
                    Temp=None):
    """Assemble TelemetryPacket as formatted bytes object."""
    ...
    _fields = [
        ...
        format_fixed_width(index     ,  5, '>05'     ),
        format_fixed_width_time(hhmmss, 6            ),
        format_fixed_width(UVA,         4,  '+02.02f'),
        format_fixed_width(UVB,         4,  '+02.02f'),
        format_fixed_width(UVC,         4,  '+02.02f'), 
        format_fixed_width(Ozone,       5,  '+02.02f'), 
        format_fixed_width(Temp,        4,  '+02.02f'), 

    ]

    _parts = '|'.join(_fields)
    pkt_string = f'D|{_parts}'
    return pkt_string.encode('ascii')
