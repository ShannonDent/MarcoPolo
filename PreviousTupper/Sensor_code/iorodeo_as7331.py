...
class AS7331:
    ...
    def read_uint16(self, reg):
        ...
        ibuffer = self.i2c_bus.readfrom_mem(self.i2c_address, obuffer[0], 2)     
        lo_byte = ibuffer[0]
        hi_byte = ibuffer[1]
    ...
    def write_uint16(self, reg, lo_byte, hi_byte): 
        ...
        obuffer[2] = hi_byte 
            #i2c.write(obuffer)
        self.i2c_bus.writeto(self.i2c_address, obuffer)
    ...
    def read_uint8(self, reg):
        ...
        ibuffer = self.i2c_bus.readfrom_mem(self.i2c_address, obuffer[0], 1)
        return ibuffer[0]
